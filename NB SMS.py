...
sms = pd.read_csv("D:\\ExcelR Data\\Assignments\\Naive bayes\\sms_raw_NB.csv",encoding='ISO-8859-1')
#importing stopwords
with open("D:\\ExcelR Data\\Assignments\\Text Mining\\stop.txt","r") as f:
